...
private:
	...
	void setDefaults()
	{
		...
		HISSTools_Text *defaultTxt = new HISSTools_Text(13, "Helvetica", HISSTools_Text::kStyleBold);
		HISSTools_Text *medTxt = new HISSTools_Text(11, "Helvetica", HISSTools_Text::kStyleBold);
		HISSTools_Text *smallTxt = new HISSTools_Text(8, "Helvetica", HISSTools_Text::kStyleBold);
